...
class JanelaPesquisarMateria(Janela):
    def __init__(self):
        super().__init__()
    ...
    def criar_janela(self):
        janela = Toplevel()
        janela.title('Pesquisar tarefa por matéria')
        janela.geometry('600x500')
        janela.resizable(True, True)

        titulo = Label(janela, text=('Insira uma matéria para pesquisar'), font=('Arial', 14))
    ...
    def criar_campos_de_entrada(self):
        label_materia = Label(self.janela, text='Matéria: ', font=('Arial', 12))
    ...
    def pesquisar_tarefas(self):
        ...
        Tarefa.exibir_tarefas_por_materia(self.input_materia.get())
